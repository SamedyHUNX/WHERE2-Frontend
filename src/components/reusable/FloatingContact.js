...
const FloatingContact = () => {
  ...
  return (
    <div className="relative">
      ...
      {alert.show && (
        <div className={`fixed top-[7vh] right-[5vw] z-50 p-4 rounded-md shadow-lg max-w-xs ${alert.type === 'success' ? 'bg-sky-500 text-white' : 'bg-red-500 text-white'}`}>
            ...
            <div className="flex justify-between items-center p-4 border-b">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  If you have any questions, feel free to contact us. We will respond back to you as soon as possible.
                </p>
              </div>
            </div>
